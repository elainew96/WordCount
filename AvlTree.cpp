     ...
     */
        ...
        AvlTree<Comparable>::AvlTree(  Comparable & notFound ) :
...
*/
template <class Comparable>
void AvlTree<Comparable>::remove( Comparable & x, AvlNode<Comparable> * & t)
{
  ...
  if(t)
    t->height = max(height(t->left), height( t->right)) + 1;
         ...
         */
        template <class Comparable>
        bool AvlTree<Comparable>::isEmpty( )
        {
            return root == NULL;
        }
        ...
        template <class Comparable>
         AvlTree<Comparable> &
        AvlTree<Comparable>::
        operator=(  AvlTree<Comparable> & rhs )
        {
            if( this != &rhs )
            {
                makeEmpty( );
        ...
        template <class Comparable>
        AvlNode<Comparable> *
        AvlTree<Comparable>::find(  Comparable & x, AvlNode<Comparable> *t )
        {
            while( t != NULL )
                if( x < t->element )
                    t = t->left;
        ...
        template <class Comparable>
        AvlNode<Comparable> *
        AvlTree<Comparable>::clone( AvlNode<Comparable> * t )
        {
            if( t == NULL )
                return NULL;
            else
